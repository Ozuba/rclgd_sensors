...
func _init_shaders() -> void:
	# 1. Stitching Shader
	var stitch_file: RDShaderFile = load("res://addons/rclgd-sensors/ros_lidar/LidarStitch.glsl")
	...
	var capture_file: RDShaderFile = load("res://addons/rclgd-sensors/ros_lidar/LidarFaceCapture.glsl")
